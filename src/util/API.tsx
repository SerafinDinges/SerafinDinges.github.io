                ...
                .then((worldDataRaw) => {
                    ...
                    worldDataRaw.forEach(line => {
                        if (countries.includes(line.iso_code)) {
                            ...
                            totalCases[line.date][line.iso_code + "_total_deaths"] = (line.total_deaths / 1); // -> total deaths in magnitudes of 1
                            totalCases[line.date][line.iso_code + "_new_deaths"] = (line.new_deaths / 1); // -> total deaths in magnitudes of 1
                            totalCases[line.date][line.iso_code + "_new_cases"] = (line.new_cases / 1); // -> total deaths in magnitudes of 1
